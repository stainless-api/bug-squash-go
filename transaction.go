...
type TransactionSourceCheckTransferIntention struct {
	...
	TransferID string                                      `json:"transfer_id,required"`
	JSON       transactionSourceCheckTransferIntentionJSON `json:"-"`
}
...
const (
	...
	// out-of-band.
	TransactionSourceCheckTransferStopPaymentRequestReasonRejectedByAcme TransactionSourceCheckTransferStopPaymentRequestReason = "rejected_by_acme"
...
type TransactionSourceInboundCheck struct {
	...
	JSON     transactionSourceInboundCheckJSON     `json:"-"`
}
